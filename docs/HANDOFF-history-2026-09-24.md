# HANDOFF history 2026-09-24 (moved out of `docs/HANDOFF.md`)

Moved 2026-09-24 when the current checkpoint exceeded the 350-line
docs limit. Content below is verbatim from `docs/HANDOFF.md` (sections
as of the one-human-to-one-AI draft round), preserving all build IDs
(`5957da33`, `9f539e50`, probes `35849621938` / `35844379073`, source
`0c0751c`) and evidence. `docs/HANDOFF.md` remains the sole current
checkpoint — read it first.
